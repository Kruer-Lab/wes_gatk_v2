...
#pipeline directory
PIPELINE="/media/sheetalshetty/Data/Pipeline_V2/"

# Samples, data and pedigrees
ALL_SAMPLES_FASTQ_DIR="/media/sheetalshetty/Data/Pipeline_V2/Data/Fastqs"
DATA="$PIPELINE/Data/"
INPUTS="${DATA}/Inputs/"
ALL_SAMPLES_OUTPUT_DIR="/media/sheetalshetty/Data/Pipeline_V2/Data/Outputs"
ANNOVAR_DIR="/media/sheetalshetty/Data/Pipeline_V2/Tools/Annovar"
PEDIGREES="/media/sheetalshetty/Data/Pipeline_V2/Data/Pedigrees"
...
#GFF="/media/sheetalshetty/Data/Pipeline_V2/Data/Inputs/Bundle/gencode.v42.basic.annotation.gff3.gz"
GFF="/media/sheetalshetty/Data/Pipeline_V2/Data/Inputs/Bundle/Homo_sapiens.GRCh38.108.chr_added.gff3"
#GFF="/media/sheetalshetty/Data/Pipeline_V2/Data/Inputs/Bundle/Homo_sapiens.GRCh38.108.chr.gff3"
#Tools
GATK="/media/sheetalshetty/Data/Pipeline_V2/Tools/GATK/gatk-4.2.6.1/gatk"
IGVTOOLS="/media/sheetalshetty/Data/Pipeline_V2/Tools/IGV/IGV_2.14.1/igvtools"
#SNPEFF="/media/sheetalshetty/Data/Pipeline_V2/Tools/snpEff/snpEff.jar"
#VEP="/media/sheetalshetty/Data/Pipeline_V2/Tools/VEP/ensembl-vep/vep"
